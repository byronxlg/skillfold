...
Use Skillfold to build and refine a team that can advance this project without you. The team is defined in `skillfold.yaml`, atomic skills live in `skills/`, and compiled agent prompts land in `dist/`. This is your toolbox - update the config, write better skills, recompose agents, and compile (`npx tsx src/cli.ts`) until the team can stand on its own.
