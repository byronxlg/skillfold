...
- VitePress documentation site (`docs/`) with GitHub Pages deployment, config reference, CLI reference, live demo with interactive pipeline visualizer, examples gallery, skill authoring guide, comparison table, and existing guides
