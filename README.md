...
Skillfold's own dev team is compiled from this repo's [`skillfold.yaml`](skillfold.yaml) - 5 flow nodes, 7 composed agents, with a review loop and conditional routing. Generated by `skillfold graph`:
