...
Skillfold's own dev team is compiled from this repo's [`skillfold.yaml`](skillfold.yaml) - 5 agents in the flow, 12 shared skills, with a review loop and conditional routing. Generated by `skillfold graph`:
...
<!-- Generated by skillfold v1.8.0 from dev-team (skillfold.yaml). Do not edit directly. -->
---
name: engineer
