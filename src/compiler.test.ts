...
describe("compile", () => {
  ...
  it("single composed skill produces file with frontmatter and bodies joined by double newline", () => {
    ...
    assert.ok(content.startsWith("<!-- Generated by skillfold from test. Do not edit directly. -->\n"));
  ...
  it("frontmatter contains correct name and description", () => {
    ...
    assert.equal(lines[0], "<!-- Generated by skillfold from test. Do not edit directly. -->");
